...
/* 
  ...
  https://create.arduino.cc/cloud/things/dbd26c19-8318-4bb3-a582-294e1ffb745f 
...
/*
  Since Solenoid is READ_WRITE variable, onSolenoidChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onSolenoidChange() {
  // Add your code here to act upon Solenoid change
  if (solenoid == 1) {
